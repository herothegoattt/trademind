    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0b0b12] px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-lg border border-purple-500/20 bg-purple-950/20 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <p className="text-gray-400 mb-6">Login to your trading account</p>
          ...
          <div className="my-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-purple-950/20 text-gray-400">No account yet?</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Secure trading dashboard • JWT Authentication • Real-time Data
        </p>
      </div>
    </div>
  );
